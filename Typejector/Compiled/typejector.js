        ...
        (function (Factory) {
            ...
            (function (Config) {
                var DependencyDescriptor = (function () {
                    ...
                    Object.defineProperty(DependencyDescriptor.prototype, "parametrTypeDescriptor", {
                        get: function () {
                            var occurrence = this.occurrence;
                            if (occurrence instanceof Config.MethodArgumentDescriptor) {
                                return occurrence.type;
                            }
                            else if (occurrence instanceof Config.PropertyDescriptor) {
                                return occurrence.type;
                            }
    ...
    (function (Component) {
        ...
        (function (Factory) {
            ...
            (function (Config) {
                ...
                Config.PropertyDescriptor = PropertyDescriptor;
            })(Config = Factory.Config || (Factory.Config = {}));
        })(Factory = Component.Factory || (Component.Factory = {}));
    })(Component = Typejector.Component || (Typejector.Component = {}));
})(Typejector || (Typejector = {}));
...
(function (Typejector) {
    ...
    (function (Component) {
        ...
        (function (Factory) {
            var Config;
            (function (Config) {
                var MethodArgumentDescriptor = (function () {
                    function MethodArgumentDescriptor() {
                    }
                    return MethodArgumentDescriptor;
                })();
                Config.MethodArgumentDescriptor = MethodArgumentDescriptor;
            })(Config = Factory.Config || (Factory.Config = {}));
        })(Factory = Component.Factory || (Component.Factory = {}));
    })(Component = Typejector.Component || (Typejector.Component = {}));
})(Typejector || (Typejector = {}));
    ...
    (function (Component) {
        ...
        (function (Factory) {
            ...
            (function (Config) {
                ...
                Config.MethodDescriptor = MethodDescriptor;
            })(Config = Factory.Config || (Factory.Config = {}));
        })(Factory = Component.Factory || (Component.Factory = {}));
    })(Component = Typejector.Component || (Typejector.Component = {}));
})(Typejector || (Typejector = {}));
    ...
    (function (Component) {
        ...
        (function (Factory) {
            ...
            (function (Support) {
                var Class = Typejector.Type.Class;
                var Collections = Typejector.Util.Collections;
                var MethodDescriptor = Typejector.Component.Factory.Config.MethodDescriptor;
                var MethodArgumentDescriptor = Typejector.Component.Factory.Config.MethodArgumentDescriptor;
                var PropertyDescriptor = Typejector.Component.Factory.Config.PropertyDescriptor;
                ...
                var DefaultBeanFactoryPostProcessor = (function (_super) {
                    ...
                    DefaultBeanFactoryPostProcessor.prototype.processMethodsArguments = function (bean, methodDescriptor, parametrsClasses) {
                        ...
                        var result = parametrsClasses
                            ...
                            var descriptor = new MethodArgumentDescriptor();
            ...
            (function (Support) {
                ...
                var AbstractAutowireCapableBeanFactory = (function (_super) {
                    ...
                    AbstractAutowireCapableBeanFactory.prototype.doResolvePropertyValues = function (beanDefinition, params) {
                        var properties = Component.BeanUtils.createPropetyValuesFrom.apply(Component.BeanUtils, [beanDefinition].concat(params));
                        var processed = this.getBeanPostProcessors()
        ...
        (function (Factory) {
            ...
            (function (Support) {
                ...
                var DefaultListableBeanFactory = (function (_super) {
                    ...
                    DefaultListableBeanFactory.prototype.doResolveDependency = function (dependencyDescriptor) {
                        var typeDescriptor = dependencyDescriptor.parametrTypeDescriptor;
                        var result;
